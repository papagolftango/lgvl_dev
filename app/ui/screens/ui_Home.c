...
lv_obj_set_style_bg_color(ui_Home, lv_color_hex(0x050000), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_homeName, lv_color_hex(0xED9515), LV_PART_MAIN | LV_STATE_DEFAULT );
