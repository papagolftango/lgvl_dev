...
uic_Energy = ui_Energy;
   ...
   printf("[ui_Energy_screen_init] called, ui_Energy=%p\n", (void*)ui_Energy);
   if (ui_Energy == NULL) {
      printf("[ui_Energy_screen_init] creating ui_Energy\n");
      ui_Energy = lv_obj_create(NULL);
      printf("[ui_Energy_screen_init] ui_Energy created: %p\n", (void*)ui_Energy);
      ...
      printf("[ui_Energy_screen_init] creating ui_Image1\n");
      ui_Image1 = lv_img_create(ui_Energy);
      printf("[ui_Energy_screen_init] ui_Image1 created: %p\n", (void*)ui_Image1);
      lv_img_set_src(ui_Image1, &ui_img_gauge_face_kw_final_png);
      lv_obj_set_width( ui_Image1, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height( ui_Image1, LV_SIZE_CONTENT);   /// 1
      lv_obj_set_align( ui_Image1, LV_ALIGN_CENTER );
